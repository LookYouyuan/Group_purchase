...
public class Order {
    ...
    public Order(int order_id, String order_name, int order_cnt, double order_price, String order_add, String order_date, int order_mode, int order_prove_id, Captain captain) {
